...
var MyApp = _spee.App;
var MyGAListener = (0, _spee.GAListener)(siteConfig); // get the state from a global variable injected into the server-generated HTML
...
sagaMiddleware.run(_spee.Sagas.rootSaga); // render the app
